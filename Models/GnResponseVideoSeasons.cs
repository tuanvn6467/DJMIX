...
*/
public class GnResponseVideoSeasons : GnDataObject {
  private HandleRef swigCPtr;

  internal GnResponseVideoSeasons(IntPtr cPtr, bool cMemoryOwn) : base(gnsdk_csharp_marshalPINVOKE.GnResponseVideoSeasons_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(GnResponseVideoSeasons obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          gnsdk_csharp_marshalPINVOKE.delete_GnResponseVideoSeasons(swigCPtr);
        }
  ...
  public static string GnType() {
    string ret = gnsdk_csharp_marshalPINVOKE.GnResponseVideoSeasons_GnType();
    return ret;
  }

  public static GnResponseVideoSeasons From(GnDataObject obj) {
    GnResponseVideoSeasons ret = new GnResponseVideoSeasons(gnsdk_csharp_marshalPINVOKE.GnResponseVideoSeasons_From(GnDataObject.getCPtr(obj)), true);
...
*/
  public uint ResultCount {
    get {
      uint ret = gnsdk_csharp_marshalPINVOKE.GnResponseVideoSeasons_ResultCount_get(swigCPtr);
      return ret;
    } 
  }
...
*/
  public uint RangeStart {
    get {
      uint ret = gnsdk_csharp_marshalPINVOKE.GnResponseVideoSeasons_RangeStart_get(swigCPtr);
      return ret;
    } 
  }
...
*/
  public uint RangeEnd {
    get {
      uint ret = gnsdk_csharp_marshalPINVOKE.GnResponseVideoSeasons_RangeEnd_get(swigCPtr);
      return ret;
    } 
  }
...
*/
  public uint RangeTotal {
    get {
      uint ret = gnsdk_csharp_marshalPINVOKE.GnResponseVideoSeasons_RangeTotal_get(swigCPtr);
      return ret;
    } 
  }
...
*/
  public bool NeedsDecision {
    get {
      bool ret = gnsdk_csharp_marshalPINVOKE.GnResponseVideoSeasons_NeedsDecision_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public GnVideoSeasonEnumerable Seasons {
    get {
      IntPtr cPtr = gnsdk_csharp_marshalPINVOKE.GnResponseVideoSeasons_Seasons_get(swigCPtr);
